    ...
    <div className='py-20' id='projects'>
      ...
      <div className='flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10'>
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          <div key={id} className='sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem] flex items-center justify-center sm:w-[570px] w-[80vw] mb-5 mt-3'>
            ...
            <div className='relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden sm:h-[40vh] h-[30vh]'>
              <div className='relative w-full h-full overflow-hidden lg:rounded-3xl bg-[#13162d]'>
                ...
                <img
                  src={img}
                  alt={title}
                  className='absolute w-full h-full object-contain z-10 top-0 left-0'
                />
              </div>
              ...
              <div className='flex item-center justify-between mt-7 mb-3'>
                ...
                <div className='flex justify-center items-center'>
                  <p className='flex lg:text-xl md:text-xs test-sm text-purple'>Check Project</p>
